...
def train(input_filepath = "profession_train.json", output_dir = "C:/Users/KishanT/OneDrive - DPR Construction/Documents/Code Arena/PDF Breakdown/2. Spacy Custom Extractor/Saved Custom Model/", model = None, n_iter = 100):
